...
class GlimpseWindow:
    ...
    def get_attention_mask(self, glimpse_params: Variable, mask_h, mask_w) -> Variable:
        """
        Draw (approximately) the area focused by attention for display purposes.

        Args:
            glimpse_params: (B, hx) A batch of hidden states
    ...
    def get_glimpse(self, images: Variable, glimpse_params: Variable) -> Variable:
        ...
        Args:
            ...
            glimpse_params: (B, 3) A batch of hidden states (x, y, delta)
